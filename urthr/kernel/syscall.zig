...
if (builtin.cpu.arch.isAARCH64())[_]Descriptor{
    ...
    .new("flock",               32,     posix.fs.sysFlock),
    .new("mkdirat",             34,     posix.fs.sysMkdirAt),
    .new("unlinkat",            35,     posix.fs.sysUnlinkAt),
    .new("symlinkat",           36,     posix.fs.sysSymlinkAt),
    .new("renameat",            38,     posix.fs.sysRenameAt),
    ...
    .new("fchmod",              52,     posix.fs.sysFchmod),
    .new("fchmodat",            53,     posix.fs.sysFchmodAt),
    .new("fchownat",            54,     posix.fs.sysFchownAt),
    .new("fchown",              55,     posix.fs.sysFchown),
    ...
    .new("sendfile",            71,     posix.fs.sysSendfile),
    .new("ppoll",               73,     posix.fs.sysPpoll),
    .new("readlinkat",          78,     posix.fs.sysReadLinkAt),
    .new("newfstatat",          79,     posix.fs.sysNewFstatAt),
    .new("fstat",               80,     posix.fs.sysFstat),
    .new("utimensat",           88,     posix.fs.sysUtimensAt),
    ...
    .new("futex",               98,     posix.sync.sysFutex),
    ...
    .new("sched_setaffinity",   122,    posix.sched.sysSchedSetAffinity),
    ...
    .new("tkill",               130,    posix.signal.sysTKill),
    .new("tgkill",              131,    posix.signal.sysTgKill),
    .new("sigaltstack",         132,    posix.signal.sysSigAltStack),
    .new("rt_sigsuspend",       133,    posix.signal.sysRtSigSuspend),
    .new("rt_sigaction",        134,    posix.signal.sysRtSigAction),
    .new("rt_sigprocmask",      135,    posix.signal.sysRtSigProcMask),
    .new("rt_sigtimedwait",     137,    posix.signal.sysRtSigTimedWait),
    .new("rt_sigreturn",        139,    posix.signal.sysRtSigReturn),
    .new("reboot",              142,    posix.task.sysReboot),
    .new("setregid",            143,    posix.task.sysSetReGid),
    .new("setgid",              144,    posix.task.sysSetGid),
    .new("setreuid",            145,    posix.task.sysSetReUid),
    .new("setuid",              146,    posix.task.sysSetUid),
    .new("setresuid",           147,    posix.task.sysSetResUid),
    .new("getresuid",           148,    posix.task.sysGetResUid),
    .new("setresgid",           149,    posix.task.sysSetResGid),
    .new("getresgid",           150,    posix.task.sysGetResGid),
    ...
    .new("getgid",              176,    posix.task.sysGetGid),
    .new("getegid",             177,    posix.task.sysGetEgid),
...
// =============================================================
    ...
    .new("sendfile",             40,    posix.fs.sysSendfile),
    ...
    .new("flock",                73,    posix.fs.sysFlock),
    ...
    .new("rename",               82,    posix.fs.sysRename),
    ...
    .new("readlink",             89,    posix.fs.sysReadLink),
    ...
    .new("lchown",               94,    posix.fs.sysLchown),
    .new("umask",                95,    posix.fs.sysUmask),
    .new("getuid",               102,   posix.task.sysGetUid),
    .new("getgid",               104,   posix.task.sysGetGid),
    .new("setuid",               105,   posix.task.sysSetUid),
    .new("setgid",               106,   posix.task.sysSetGid),
    .new("geteuid",              107,   posix.task.sysGetEuid),
    .new("getegid",              108,   posix.task.sysGetEgid),
    .new("setpgid",              109,   posix.task.sysSetPgid),
    .new("getppid",              110,   posix.task.sysGetPpid),
    .new("setsid",               112,   posix.task.sysSetsid),
    .new("setreuid",             113,   posix.task.sysSetReUid),
    .new("setregid",             114,   posix.task.sysSetReGid),
    .new("setgroups",            116,   posix.task.sysSetGroups),
    .new("setresuid",            117,   posix.task.sysSetResUid),
    .new("getresuid",            118,   posix.task.sysGetResUid),
    .new("setresgid",            119,   posix.task.sysSetResGid),
    .new("getresgid",            120,   posix.task.sysGetResGid),
    .new("getpgid",              121,   posix.task.sysGetPgid),
    .new("getsid",               124,   posix.task.sysGetsid),
    .new("rt_sigtimedwait",      128,   posix.signal.sysRtSigTimedWait),
    .new("rt_sigsuspend",        130,   posix.signal.sysRtSigSuspend),
    ...
    .new("tkill",                200,   posix.signal.sysTKill),
    .new("futex",                202,   posix.sync.sysFutex),
    .new("sched_setaffinity",    203,   posix.sched.sysSchedSetAffinity),
