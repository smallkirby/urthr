...
![Build Rpi5](https://github.com/smallkirby/urthr/actions/workflows/build-rpi5.yml/badge.svg)
...
![Runtime Test Q35](https://github.com/smallkirby/urthr/actions/workflows/runtime-test-q35.yml/badge.svg)
...
| Group | Feature | RPi5 | RPi4B | virt | Q35 |
| --- | --- | --- | --- | --- | --- |
...
| `init` | Path | Path to init binary to run on boot. | `/bin/init` |
